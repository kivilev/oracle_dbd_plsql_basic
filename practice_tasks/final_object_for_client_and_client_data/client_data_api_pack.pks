create or replace package client_data_api_pack is
  ...
  c_empty_field_id_in_client_data constant varchar2(200 char) := 'ID поля в данных не может быть пустым';
  c_empty_value_in_client_data    constant varchar2(200 char) := 'Значение в данных не может быть пустым';
